...
map.getView().fit([-378001.424250, 1226489.515548, -92401.121862, 1447895.549767], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">DENSITE DE POPULATION PAR COMMUNES DE LA REGION DE NANDO EN 2019</h2>';
        return titleElement;
    })(),
